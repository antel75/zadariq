...
export const businesses: Business[] = [
  ...
  { id: 'dn39', name: 'Stom. ordinacija Tereza Čuka', category: 'dentist', address: 'Ul. Andrije Medulića 1, Zadar', phone: '023 213 900', workingHours: wh('08:00–15:00', 'Zatvoreno', 'Zatvoreno'), verified: true, lastVerified: '2026-02-14', reportCount: 0, verificationStatus: 'community', communityConfirmedAt: hoursAgo(5), lastAutoChecked: hoursAgo(3), trustScore: 67, lat: 44.1143, lng: 15.2265 },
  { id: 'dn40', name: 'Perković Nada, dr. med. dent.', category: 'dentist', address: 'Stadionska ul. 2, Zadar', phone: '023 314 268', workingHours: wh('08:00–15:00', 'Zatvoreno', 'Zatvoreno'), verified: true, lastVerified: '2026-02-14', reportCount: 0, verificationStatus: 'community', communityConfirmedAt: hoursAgo(7), lastAutoChecked: hoursAgo(4), trustScore: 63, lat: 44.1180, lng: 15.2270 },
  ...
  { id: 'dn43', name: 'Perovic — stomatološka ordinacija', category: 'dentist', address: 'Ul. Svetog Vinka Paulskog 35, Zadar', phone: '023 385 304', workingHours: wh('08:00–16:00', '08:00–12:00', 'Zatvoreno'), verified: true, lastVerified: '2026-02-14', reportCount: 0, verificationStatus: 'community', communityConfirmedAt: hoursAgo(6), lastAutoChecked: hoursAgo(4), trustScore: 66, lat: 44.1179, lng: 15.2198 },
  ...
  { id: 'dn45', name: 'Stom. ordinacija dr. Jadranka pl. Vusio', category: 'dentist', address: 'Put Murata 18C, Zadar', phone: '023 230 964', workingHours: wh('08:00–15:00', 'Zatvoreno', 'Zatvoreno'), verified: true, lastVerified: '2026-02-14', reportCount: 0, verificationStatus: 'community', communityConfirmedAt: hoursAgo(7), lastAutoChecked: hoursAgo(4), trustScore: 64, lat: 44.1212, lng: 15.2258 },
  { id: 'dn46', name: 'Stom. ordinacija Antun Merlo', category: 'dentist', address: 'Ul. Andrije Medulića 1, Zadar', phone: '023 311 144', workingHours: wh('08:00–15:00', 'Zatvoreno', 'Zatvoreno'), verified: true, lastVerified: '2026-02-14', reportCount: 0, verificationStatus: 'community', communityConfirmedAt: hoursAgo(6), lastAutoChecked: hoursAgo(4), trustScore: 66, lat: 44.1143, lng: 15.2266 },
  ...
  { id: 'dn50', name: 'Ljuba Matić, dr. dent. med.', category: 'dentist', address: 'Ul. bana Josipa Jelačića 15C, Zadar', phone: '091 512 1325', workingHours: wh('08:00–16:00', '08:00–12:00', 'Zatvoreno'), verified: true, lastVerified: '2026-02-14', reportCount: 0, verificationStatus: 'community', communityConfirmedAt: hoursAgo(6), lastAutoChecked: hoursAgo(4), trustScore: 66, lat: 44.1137, lng: 15.2273 },
