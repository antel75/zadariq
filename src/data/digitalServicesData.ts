  ...
  },
  {
    ...
    services: [
      ...
      },
      {
        id: 'ezadrani',
        name: 'eZadrani',
        description: 'Portal e-usluga Grada Zadra — 26+ usluga (dozvole, financije, komunalni poslovi...)',
        loginUrl: 'https://ezadrani.hr/',
        icon: 'Building2',
        proTip: 'Prijava preko sustava e-Građani (eOI ili FINA certifikat)',
      },
      {
        id: 'grad-zadar',
        name: 'Grad Zadar — Obavijesti',
        description: 'Službeni portal Grada Zadra, obavijesti i vijesti',
