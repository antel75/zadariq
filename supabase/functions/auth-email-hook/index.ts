...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Potvrdi svoju email adresu — ZadarIQ',
  invite: 'Pozvan/a si na ZadarIQ',
  magiclink: 'Tvoj link za prijavu — ZadarIQ',
  recovery: 'Resetiraj lozinku — ZadarIQ',
  email_change: 'Potvrdi promjenu email adrese — ZadarIQ',
  reauthentication: 'Tvoj verifikacijski kôd — ZadarIQ',
}
...
// Configuration
const SITE_NAME = "zadariq"
const SENDER_DOMAIN = "mail.zadariq.city"
const ROOT_DOMAIN = "zadariq.city"
const FROM_DOMAIN = "mail.zadariq.city" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://zadariq.lovable.app"
